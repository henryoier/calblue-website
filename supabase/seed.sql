...
-- --------------------------------------------------------------- identities
-- One account holds at most one identity. Grace and Hugo have no account:
-- Grace is a drop-in guest, Hugo is Eve's child and Eve pays for him.
...
insert into public.games
  (id, competition_id, team_id, game_type, title, opponent, home_away, venue_id,
   ...
   registration_closes_at, status, fee_override, kit_color, notes)
values
  ...
  ('88888888-0000-4000-a000-000000000001', null, '33333333-0000-4000-a000-000000000001',
   ...
   'published', 10.00, 'blue', 'Bring both shirts.'),
...
--   * 6 accounts, 8 identities (2 without a login)

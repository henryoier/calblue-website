...
export function QuarterlyCloseView(mainEl) {
  mount(mainEl, html`
    <section>
      <h1>Quarterly close</h1>
      <p class="app-muted">#45 — Preview, reconcile, lock. Refuses while any game in window unfinalised. Closed = immutable, corrections via adjustment period.</p>

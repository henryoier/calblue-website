...
export function PaymentsView(mainEl) {
  mount(mainEl, html`
    <section>
      <h1>Payments admin</h1>
      <p class="app-muted">#44 — Record payment Venmo/Zelle/cash, allocate to person, issue manual charge/credit, void with reason, ledger v_account_ledger. Charges immutable.</p>

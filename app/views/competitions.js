...
export function CompetitionsView(mainEl) {
  mount(mainEl, html`
    <section>
      <h1>Competitions</h1>
      <p class="app-muted">#39 — Create, publish, manage league/cup. Lifecycle draft→published→in_progress→completed→archived. Organiser grant scoped.</p>

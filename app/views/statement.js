...
export function StatementView(mainEl) {
  mount(mainEl, html`
    <section>
      <h1>Member statement</h1>
      <p class="app-muted">#46 — Running balance v_account_balance, ledger v_account_ledger newest first, every charge naming game, guardian rollup.</p>

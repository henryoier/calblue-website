...
window.CALBLUE_DESIGNS = Object.freeze({
  ...
  designs: Object.freeze([
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260908b'],
      themeColor: '#071b3f',
    ...
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260908b', 'designs/codex-pro.css?v=20260826a'],
      themeColor: '#061724',
    ...
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260908b', 'designs/musecode-pro/theme.css?v=20260908b'],
      themeColor: '#061024',
    ...
    Object.freeze({
      ...
      stylesheets: ['designs/floodlight/theme.css?v=20260908b'],

...
window.CALBLUE_DESIGNS = Object.freeze({
  ...
  designs: Object.freeze([
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260921c'],
      themeColor: '#071b3f',
    ...
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260921c', 'designs/codex-pro.css?v=20260826a'],
      themeColor: '#061724',
    ...
    Object.freeze({
      ...
      stylesheets: ['styles.css?v=20260921c', 'designs/musecode-pro/theme.css?v=20260913a'],
      themeColor: '#061024',
    ...
    Object.freeze({
      ...
      stylesheets: ['designs/floodlight/theme.css?v=20260921c'],
